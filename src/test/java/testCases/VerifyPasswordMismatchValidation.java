...
public class VerifyPasswordMismatchValidation extends BaseClass {
	...
	public void verify_account_registration() throws InterruptedException {
		...
		String email=randomStringGen()+"$gmail";
		arp.setEmail("");
		...
		arp.setConfirmPassword("1234567543");
		//Thread.sleep(2000);
		...
		boolean st=arp.getPasswdMismatchMsgDisplay();
		//Thread.sleep(2000);
